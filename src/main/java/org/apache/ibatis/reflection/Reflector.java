...
public class Reflector {
    ...
    private void addGetMethod(String name,
                              Method method,
                              boolean isAmbiguous) {
    ...
    private Method pickBetterSetter(Method setter1,
        ...
        MethodInvoker invoker = new AmbiguousMethodInvoker(setter1,
                MessageFormat.format(
                        "Ambiguous setters defined for property ''{0}'' in class ''{1}'' with types ''{2}'' and " +
                                "''{3}''.", property,
    ...
    private void addSetMethod(String name,
                              Method method) {
    ...
    private void addUniqueMethods(Map<String, Method> uniqueMethods,
                                  Method[] methods) {
